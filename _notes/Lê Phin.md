...
<iframe src="https://www.instagram.com/p/C1nozB_Pfuc/embed" frameborder="0" scrolling="auto" allowtransparency="true" height="600"></iframe>

<img src="assets/ny_lephin_01.jpg">
...
## 위치
259 E 10th St, East Village, New York, NY 10009, USA

## [🗺️ 구글맵](https://maps.google.com/?cid=1173281705050019322)

<!-- TODO
□ (해결) 사진은 NYLON 기사에서 가져왔다 — assets/ny_lephin_01.jpg (사용자 지시 2026-09-12).
   이 컷이 맞는 근거: 선반의 베트남식 핀(phin) 드리퍼 4개 · 베트남어 책 'Bắt đầu bằng… để lại' ·
   테이블의 베트남식 아이스커피 · 창밖 이스트빌리지 거리 — 기사 본문 "Sipping a Vietnamese iced coffee
   at Lê Phin, a quaint cafe in the heart of the East Village" 와 일치. 크레딧 SOURCE MUSIC/HYBE.
   ※ 같은 기사의 다른 컷들은 빈티지숍(Metropolis)·거리 사진이라 이 카페가 아니다.
□ (참고) IG C1nozB_Pfuc 캐러셀 10장은 전부 미술관 사진이라 이 카페와 무관 (2026-09-12 재확인).
□ (해결) 검증 가능한 출처가 NYLON 기사라 `외부컨텐츠` 태그를 추가했다 (사용자 지시 2026-09-12).
   `인스타` 는 같은 날 윤진 피드 포스트가 있어 함께 남겨둔다.
