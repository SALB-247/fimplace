...
## 위치
No. 13, Lane 53, Sec. 2, Chengde Rd, 承德路二段53巷13號, 大同區 Datong, 103 Taipei, Taiwan
...
□ ⚠️ 위치 불일치: 메모는 '시먼딩'인데 이 가게는 **中山역 인근 大同區 承德路二段53巷13號** (시먼딩=萬華區). 주소는 웹 검증 완료 — 영상에 실제로 나왔는지 확인 필요
□ 좌표가 이웃 노트 LazyDer(같은 골목 17號)과 소수점까지 동일 — 골목 단위 지오코딩 결과로 보임. 정밀 좌표 필요시 개별 확인
□ 참고: Marie Claire 기사가 '允真(윤진) 동일 메뉴'로 이 가게를 소개 — 멤버 연관 단서 (https://www.marieclaire.com.tw/lifestyle/taste/91120)
-->
